...
hist(apply(countsTableRound,1,mean),xlim=c(0,100), ylim=c(0,60000),breaks=10000)
...
## [1] "Intercept"            "generation_F11_vs_F0" "generation_F2_vs_F0"  "generation_F4_vs_F0"  "treatment_OA_vs_AM"   "treatment_OW_vs_AM"  
